...
pos_tweets = pd.DataFrame(list(open('/Users/fatusgauthier/Desktop/Twitter_Sentiment_Analysis-master/data/datasets/train_neg_small.txt', errors='ignore')), columns=['tweet'])
pos_tweets['sentiment'] = 1
neg_tweets = pd.DataFrame(list(open('/Users/fatusgauthier/Desktop/Twitter_Sentiment_Analysis-master/data/datasets/train_pos_small.txt', errors='ignore')), columns=['tweet'])
neg_tweets['sentiment'] = -1
tweets = pd.concat([pos_tweets, neg_tweets], axis=0)

test_tweets = pd.DataFrame(list(open('/Users/fatusgauthier/Desktop/Twitter_Sentiment_Analysis-master/data/datasets/test_data.txt', errors='ignore')), columns=['tweet'])
